...
int errorHandler(char *errorType)
{
    ...
    {
        printf("Error ::: Requested effective memory address if out of range (4096).\n");
        exit(1);
    }
    return 0;
}
...
APEX_decode(APEX_CPU *cpu)
{
    if (cpu->decode.has_insn)
    {
        ...
        case OPCODE_LDR:
        {
            if (!cpu->registerStatus[cpu->decode.rs1] && !cpu->registerStatus[cpu->decode.rs2] && !cpu->registerStatus[cpu->decode.rd])
            {
        ...
        case OPCODE_CMP:
        {
            if (!cpu->registerStatus[cpu->decode.rs1] && !cpu->registerStatus[cpu->decode.rs2])
            {
                cpu->decode.rs1_value = cpu->regs[cpu->decode.rs1];
                cpu->decode.rs2_value = cpu->regs[cpu->decode.rs2];
                cpu->decode.stalled = 0;
        ...
        case OPCODE_LOAD:
        {
            if (!cpu->registerStatus[cpu->decode.rs1] && !cpu->registerStatus[cpu->decode.rd])
            {
                cpu->decode.rs1_value = cpu->regs[cpu->decode.rs1];
                cpu->registerStatus[cpu->decode.rd] = 1;
                cpu->decode.stalled = 0;
        ...
        case OPCODE_STR:
        {
            if (!cpu->registerStatus[cpu->decode.rs1] && !cpu->registerStatus[cpu->decode.rs2] && !cpu->registerStatus[cpu->decode.rs3])
            {
                cpu->decode.rs1_value = cpu->regs[cpu->decode.rs1];
                cpu->decode.rs2_value = cpu->regs[cpu->decode.rs2];
...
void APEX_cpu_run(APEX_CPU *cpu)
{
    ...
    while (TRUE) /*Shweta : Run CPU untile clock is less than equal to code memory size*/
    {
